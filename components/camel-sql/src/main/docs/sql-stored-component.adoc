...
It can be either a Simple expression or header location that is, `:#<header name>`. For example,
...
URI means that the stored procedure will be called with parameter name _param1_,

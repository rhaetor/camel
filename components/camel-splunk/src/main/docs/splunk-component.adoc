...
option on the producer endpoint. This is useful for for example, json/xml and
...
For example, the jmx app could be used to publish jmx attributes, for example:

...
A *bean:* endpoint cannot be defined as the input to the route; that is, you
...
(that is, `to("bean:beanName")`) you can use the following syntax:
...
look for it in the xref:manual::registry.adoc[Registry]), you can specify the bean itself:

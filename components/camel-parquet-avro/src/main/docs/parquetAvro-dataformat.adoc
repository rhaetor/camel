...
Messages can be unmarshaled to Avro's GenericRecords or plain Java objects (POJOs).
...
Marshaling is the reverse process of unmarshaling, so when you have your GenericRecord or POJO and marshalit, you will get the parquet-formatted output stream on your producer endpoint.

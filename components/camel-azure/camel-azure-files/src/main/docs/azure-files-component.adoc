...
When consuming from a remote file server, make sure you read the section titled _Consuming Files_
...
it is necessary to fall back to regular filters (that is, the list

...
@EnabledIfSystemProperty(named = "vaultName", matches = ".*",
                         disabledReason = "Make sure to supply azure key vault Vault Name, for example, mvn verify -DvaultName=string")
@EnabledIfSystemProperty(named = "clientId", matches = ".*",
                         disabledReason = "Make sure to supply azure key vault Client Id, for example, mvn verify -DclientId=string")
@EnabledIfSystemProperty(named = "clientSecret", matches = ".*",
                         disabledReason = "Make sure to supply azure key vault Client Secret, for example, mvn verify -DclientSecret=string")
@EnabledIfSystemProperty(named = "tenantId", matches = ".*",
                         disabledReason = "Make sure to supply azure key vault Tenant Id, for example, mvn verify -DtenantId=string")

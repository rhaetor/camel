...
encryption to ciphertext and unmarshaling to mean decryption back to
...
== Support for Sub-Keys and Key Flags in PGP Data Format Marshaler
...
these Key Flags of the primary key and sub-keys to determine

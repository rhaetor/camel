...
encryption to cyphertext and unmarshaling to mean decryption back to
...
To use such a vector with the CryptoDataFormat, you can configure it with a byte[] containing the required data, for example

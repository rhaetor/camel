...
== Unmarshaling a CSV message into a Java List

Unmarshaling will transform a CSV message into a Java List with CSV
...
== Marshaling a List<Map> to CSV

*Since Camel 2.1*

If you have multiple rows of data you want to be marshaled into CSV

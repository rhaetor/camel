...
Type Converter support for Spring Resources, and so on.
...
packages that should be searched for example
...
applied to the fully qualified names of the discovered classes. for example
...
You can allow Camel to scan the container context, for example, the Spring

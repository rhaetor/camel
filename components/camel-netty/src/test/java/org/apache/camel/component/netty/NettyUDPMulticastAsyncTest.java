 ...
 * </pre>
 *
 * Please note that using the JUnit {@link BeforeAll} annotation together with the corresponding
 * {@link System#setProperty(String, String) Java API} to set the {@code java.net.preferIPv4Stack} system property would
 * not work here as at that moment it would be too <b>late</b> to set this system property. On the other hand setting
 * such a system property through the surefire-plugin would cause side effect by the other tests of this component.
 */

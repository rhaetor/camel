...
=== Usage example: marshaling a Map into CSV format
...
=== Usage example: marshaling a Map into fixed-width format
...
=== Usage example: marshaling a Map into TSV format
...
The unmarshaling uses an `InputStream` to read the data.
...
=== Usage example: unmarshaling a CSV format into maps with automatic headers
...
=== Usage example: unmarshaling a fixed-width format into lists

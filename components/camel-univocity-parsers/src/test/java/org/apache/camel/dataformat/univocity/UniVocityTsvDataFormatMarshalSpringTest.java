...
/**
 * This class tests the marshaling of {@link org.apache.camel.dataformat.univocity.UniVocityTsvDataFormat} using the
 * Spring DSL.
 */
public final class UniVocityTsvDataFormatMarshalSpringTest extends CamelSpringTestSupport {
    ...
    /**
     * Tests that we can marshalTSV with the default configuration.
     */
    @Test
    ...
    /**
     * Tests that we can marshalTSV with specific headers
     */
    @Test
    ...
    /**
     * Tests that we can marshalTSV using and advanced configuration
     */
    @Test

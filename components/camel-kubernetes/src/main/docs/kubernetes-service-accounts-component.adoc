...
- listServiceAccounts: this operation lists the service accounts on a kubernetes cluster
...
- listServiceAccountsByLabels: this operation lists the service accounts by labels on a kubernetes cluster

...
:description: The splunk component allows you to publish events in Splunk using the HTTP Event Collector.
:since: 3.3
:supportlevel: Stable
:tabs-sync-option:
...
The Splunk HEC component allows sending data to Splunk using the

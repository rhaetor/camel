...
If an 8-bit character set is used (for example, ISO-8859-1 for Western Europe), then 140 characters will be
...
code to the SMSC. This feature is useful to for example, instruct the SMSC to

...
invoke; or the complete URL of the remote template (for example:
...
You can set up a custom Velocity Context yourself by
...
And to use the content cache, for example, for use in production, where the

...
SEDA component differs from the rest components provided. It implements a work-queue to support asynchronous SEDA architectures, similar to the core "SEDA" component.

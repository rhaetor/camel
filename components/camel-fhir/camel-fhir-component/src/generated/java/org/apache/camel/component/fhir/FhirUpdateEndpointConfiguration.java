...
public final class FhirUpdateEndpointConfiguration extends FhirConfiguration {
    ...
    @UriParam
    @ApiParam(optional = false, apiMethods = {@ApiMethod(methodName = "resource", description="The resource to update (for example, Patient)"), @ApiMethod(methodName = "resourceBySearchUrl", description="The resource to update (for example, Patient)")})

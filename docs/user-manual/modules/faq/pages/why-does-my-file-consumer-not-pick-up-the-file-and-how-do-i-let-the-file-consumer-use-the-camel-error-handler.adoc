...
(for example, in the routes) only applies when a message is being routed by the
routing engine.
...
xref:ROOT:exchange.adoc[Exchange] with message details (for example, body and

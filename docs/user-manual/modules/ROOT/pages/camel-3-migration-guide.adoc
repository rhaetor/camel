...
The `camel-telegram` component has moved the authorization token from uri-path to a query parameter instead, for example, migrate
...
Most of the Camel exception classes have been migrated to be unchecked (for example, extends `RuntimeException`).

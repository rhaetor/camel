...
* `*Test.java` (that is:  MyComponentTest.java) for unit tests.
* `*IT.java` (that is:  MyComponentIT.java) for integration tests.
* `*ManualTest.java` (that is:  MyComponentManualTest.java) for manual tests.

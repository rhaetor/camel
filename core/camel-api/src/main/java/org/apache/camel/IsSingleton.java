 ...
 * <p/>
 * This interface is not implemented as a marker interface (that is, it's necessary to read {@link #isSingleton()} instead
 * of <tt>instanceof(IsSingleton))</tt>. This allows for subclasses to have a singleton status different from a parent

...
The content enricher (`pollEnrich`) retrieves additional data from a _resource endpoint_ to enrich an incoming message (contained in the _original exchange_).
